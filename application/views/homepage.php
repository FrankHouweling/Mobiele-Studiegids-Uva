		...
		<ul class="homelist">
			...
			<li>
				<a href="index.php/zoeken/faculteit">
			...
			<li class="newrule">
				<a href="index.php/zoeken/toelatingseisen">
			...
			<li>
				<a href="index.php/zoeken/keyword">
					
					<img src="/client/img/button-left.gif" alt="Zoeken" class="left" />
					<img src="/client/img/button-right.gif" alt="Zoeken" class="right" />
					
					<img src="/client/img/zoeken_icon.gif" alt="Zoeken" class="icon" style="margin-top:16px;" />
